...
class Credit
{
    public static void main(String[] args) 
    {
        ...
        // Maximum value that a credit card can get/10
        long max = 100000000000000000L; 

        // Min value that a credit card can get/10
        ...
        if (num*10<max && num>min)
        {
            ...
            // return k to 0 prevent becoming garbage
            k=0; 
            int checkSum = 0;
            ...
            {
                // sum even numbered positions
                checkSum += numberArray[m-1]; 
                ...
                {
                    // Check for multiplications > 10 to add those digits (eg: 6*2 = 12 >> 3)
                    checkSum += 2*numberArray[m]-9; 
                }
            }
